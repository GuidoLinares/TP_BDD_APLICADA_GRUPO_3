...
grant execute on [dbo].[sp_Reporte_5_Morosidad] to Administrativo_General
grant execute on [dbo].[sp_Reporte_5_Morosidad] to Administrativo_Bancario
grant execute on [dbo].[sp_Reporte_5_Morosidad] to Administrativo_Operativo
grant execute on [dbo].[sp_Reporte_5_Morosidad] to Sistemas
